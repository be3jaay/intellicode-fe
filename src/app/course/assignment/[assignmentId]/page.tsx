                            ...
                            >
                                <Stack gap="sm">
                                    <Text size="sm" c="dimmed">
                                        Any attempt to leave this page will result in automatic submission.
                                    </Text>
                                    <Text size="sm" c="dimmed">
                                    ...
                                    >
                                        <List.Item color="#ef4444" styles={{
                                            itemLabel: {
                                                color: "#ef4444",
                                                fontWeight: 600,
                                            }
                                        }}>Leave this page or switch tabs</List.Item>
                                        <List.Item color="#ef4444" styles={{
                                            itemLabel: {
                                                color: "#ef4444",
                                                fontWeight: 600,
                                            }
                                        }}>Open new windows or tabs</List.Item>
                                        <List.Item color="#ef4444" styles={{
                                            itemLabel: {
                                                color: "#ef4444",
                                                fontWeight: 600,
                                            }
                                        }}>Use browser developer tools</List.Item>
                                    </List>
