...
import { useUsers, usePendingApprovals, useSuspendedUsers, useSuspendUser, useApproveInstructor } from "@/hooks/query-hooks/user-management-query";
import { UserProfile, UserManagementQuery, SuspendUserRequest, ApproveInstructorRequest } from "@/services/user-service/user-management-types";
...
export default function UserManagementPage() {
    ...
    const queryParams: UserManagementQuery = {
        ...
        isSuspended: statusFilter === 'suspended' ? true : statusFilter === 'active' ? false : undefined,
    };
    ...
    const { data: suspendedUsers, isLoading: suspendedLoading, refetch: refetchSuspended } = useSuspendedUsers();
