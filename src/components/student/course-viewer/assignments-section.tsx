...
export function AssignmentsSection({
  ...
  const getAssignmentButtonConfig = (
    type:
      | "quiz_form"
      | "code_sandbox"
      | "file_upload"
          ...
          onClick: () =>
            router.push(
              `/dashboard/student/assignment/${
                assignments.find((a) => a.assignment_type === type)?.id
              }?courseId=${courseId}`
            ),
        };
      case "code_sandbox":
                ...
                <Flex justify="space-between" align="flex-start" wrap="wrap">
                  ...
                  <Group gap="sm">
                    {assignment.is_submitted ? (
                      ...
                      (() => {
                        const buttonConfig = getAssignmentButtonConfig(
                          assignment.assignment_subtype as
                            | "quiz_form"
                            | "code_sandbox"
                            | "file_upload"
                            | "essay"
                          ...
                          <Button
                            ...
                            onClick={() => {
                              if (
                                ...
                                router.push(
                                  `/dashboard/student/sandbox/${assignment.id}?courseId=${courseId}`
                                );
                              } else if (
                                assignment.assignment_subtype === "file_upload"
                              ) {
                                router.push(
                                  `/dashboard/student/submission/${assignment.id}?courseId=${courseId}`
                                );
                              } else {
                                router.push(
                                  `/dashboard/student/assignment/${assignment.id}?courseId=${courseId}`
                                );
                              }
                            }}
                            style={{
