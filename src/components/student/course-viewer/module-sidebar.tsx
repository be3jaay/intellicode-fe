      ...
      {modules.map((module, index) => {
        ...
        return (
          <Card
            ...
            p="md"
            style={{
              background: isSelected ? "#b3a1ff10" : "#1a1a1a",
              border: isSelected ? "1px solid #b3a1ff" : "1px solid #333",
              cursor: "pointer",
              ...
              <Flex justify="space-between" align="center">
                <Group gap="xs">
                  ...
                  {isExpanded ? (
                    <IconChevronDown
                      size={16}
                      color={isSelected ? "#b3a1ff" : "#ffffff"}
                    />
                  ) : (
                    <IconChevronRight
                      size={16}
                ...
                <Badge
                  ...
                  variant="light"
                  color={
                    module.completion_percentage === 100 ? "green" : "blue"
                  }
                >
