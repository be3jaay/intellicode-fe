...
import { UserCheck, UserX, BookOpen, AlertTriangle } from "lucide-react";
import {
  UserProfile,
            ...
            <Stack gap="lg">
              ...
              {user.approval_reason && (
                <div
                  style={{
                    padding: "1rem",
                    backgroundColor: isCurrentlyApproved
                      ? "#064E3B"
                      : "#92400E",
                    borderRadius: "8px",
                    border: `1px solid ${
                      isCurrentlyApproved ? "#10B981" : "#F59E0B"
                    }`,
                  }}
                >
