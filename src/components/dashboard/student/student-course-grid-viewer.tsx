...
import { Search, Users, BookOpen, Filter, ChevronDown, AlertCircle } from "lucide-react";
...
export function StudentCourseGridViewer({
    ...
    const categories = ["all", ...Array.from(new Set(enrollments.map(e => e.course.category)))];
