...
export function StudentCourseViewer() {
  ...
  const categories = [
    "all",
    ...Array.from(new Set(allEnrollments.map((e) => e.course.category))),
  ];
        ...
        >
          ...
          <Button
            ...
            style={{
              ...
              border: "none",
              boxShadow:
                "0 4px 16px rgba(189, 240, 82, 0.3), 0 0 0 1px rgba(189, 240, 82, 0.2)",
              ...
              <Badge
                ...
                style={{
                  ...
                  border:
                    selectedCategory === cat
                      ? "none"
                      : "1px solid rgba(179, 161, 255, 0.3)",
                  fontWeight: 600,
                  padding: "8px 16px",
                  transition: "all 0.2s ease",
                }}
        ...
        >
          <Box
            style={{
              ...
              height: 400,
              background:
                "radial-gradient(circle, rgba(246, 172, 174, 0.08) 0%, transparent 70%)",
              filter: "blur(80px)",
              pointerEvents: "none",
            }}
          />
          ...
          >
            <Box
              style={{
                ...
                borderRadius: "50%",
                background:
                  "linear-gradient(135deg, rgba(246, 172, 174, 0.2) 0%, rgba(248, 113, 113, 0.2) 100%)",
                display: "flex",
                alignItems: "center",
        ...
        >
          <Box
            style={{
              ...
              height: 400,
              background:
                "radial-gradient(circle, rgba(189, 240, 82, 0.08) 0%, transparent 70%)",
              filter: "blur(80px)",
              pointerEvents: "none",
            }}
          />
          ...
          >
            <Box
              style={{
                ...
                borderRadius: "50%",
                background:
                  "linear-gradient(135deg, rgba(189, 240, 82, 0.15) 0%, rgba(163, 215, 66, 0.15) 100%)",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
