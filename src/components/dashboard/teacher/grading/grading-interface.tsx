...
export function GradingInterface({ submission, onClose }: GradingInterfaceProps) {
    ...
    const isImageFile = (file: any) => {
        return file?.mime_type?.startsWith("image/") || ["jpg", "jpeg", "png", "gif", "webp"].includes(file?.file_type);
    };
                        ...
                        <Stack gap="md">
                            ...
                            {submission.files.length > 1 && (
                                <Group justify="space-between">
                                    ...
                                    <Button
                                        ...
                                        style={{
                                            color: selectedFileIndex === submission.files.length - 1 ? "#6b7280" : "#bdf052",
                                        }}
                                    >
                                        Next
                                    </Button>
                            ...
                            >
                                <Group justify="space-between" wrap="nowrap">
                                    <Group gap="xs">
                                        ...
                                        <Box>
                                            <Text size="sm" c="#e9eeea" truncate style={{ maxWidth: 300 }}>
                                    ...
                                    <Group gap="xs">
                                        ...
                                        <ActionIcon
                                            variant="light"
                                            size="sm"
                                            onClick={() => handleDownloadFile(selectedFile.public_url, selectedFile.original_name)}
                                            style={{
                            ...
                            >
                                {isPdfFile(selectedFile) ? (
                                    ...
                                    <Box p="md" style={{ display: "flex", justifyContent: "center", alignItems: "center", minHeight: 400 }}>
                                        <Image
                                    ...
                                    <Stack gap="xs">
                                        {submission.files.map((file, index) => (
                                            <Card
                                                ...
                                                radius="sm"
                                                style={{
                                                    background: index === selectedFileIndex ? "rgba(189, 240, 82, 0.1)" : "rgba(26, 26, 26, 0.6)",
                                                    border: index === selectedFileIndex ? "1px solid rgba(189, 240, 82, 0.3)" : "1px solid rgba(189, 240, 82, 0.1)",
                                                    cursor: "pointer",
                                                }}
                                                onClick={() => setSelectedFileIndex(index)}
                                            >
                                                <Group gap="xs" wrap="nowrap">
                                                    <File size={12} color={index === selectedFileIndex ? "#bdf052" : "#9ca3af"} />
                                                    <Text size="xs" c={index === selectedFileIndex ? "#e9eeea" : "dimmed"} truncate style={{ flex: 1 }}>
                                                        {file.original_name}
                                                    </Text>
                                                </Group>
                                            </Card>
