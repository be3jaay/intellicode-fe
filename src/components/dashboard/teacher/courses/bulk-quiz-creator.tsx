...
export function BulkQuizCreator({ course, onBack }: BulkQuizCreatorProps) {
    ...
    const validateAndCleanQuestion = (question: QuizQuestion): QuizQuestion | null => {
        ...
        if (question.type === "multiple_choice") {
            ...
            cleanQuestion.is_true = question.is_true === true || question.is_true === "true"
        }
    ...
    const onSubmit = (data: QuizFormData) => {
        // Validate and clean all questions
        ...
        console.log("=== BULK QUIZ SUBMISSION ===")
        console.log("Course ID:", course.id)
        console.log("Total questions:", cleanedQuestions.length)
        console.log("Total points:", totalPoints)
        console.log("\nQuestion breakdown:")
        const typeCount = cleanedQuestions.reduce((acc: any, q) => {
            acc[q.type] = (acc[q.type] || 0) + 1
            return acc
        }, {})
        console.log("- Multiple Choice:", typeCount.multiple_choice || 0)
        console.log("- Enumeration:", typeCount.enumeration || 0)
        console.log("- Identification:", typeCount.identification || 0)
        console.log("- True/False:", typeCount.true_false || 0)
        console.log("\nClean question data:", JSON.stringify(cleanedQuestions, null, 2))
    }
                                                        ...
                                                        <Stack gap="md">
                                                            ...
                                                            {questionType === "enumeration" && (
                                                                <Box>
                                                                    ...
                                                                    <Stack gap="xs">
                                                                        {(watch(`questions.${index}.correct_answers`) || []).map((_, ansIndex) => (
                                                            ...
                                                            {questionType === "identification" && (
                                                                <Box>
                                                                    ...
                                                                    <Switch
                                                                        ...
                                                                        color="cyan"
                                                                        mt="sm"
                                                                        {...register(`questions.${index}.case_sensitive`)}
                                                                        styles={{
                                                                            label: {
                                                                                color: "#e9eeea",
                                                                                cursor: "pointer",
                                ...
                                >
                                    <Group justify="space-between" align="center">
                                        <Box>
                                            ...
                                            <Text size="sm" c="dimmed">
                                                You have <strong style={{ color: "#ffffff" }}>{fields.length}</strong> question
                                                {fields.length !== 1 ? "s" : ""} ready • Total points:{" "}
                                                <strong style={{ color: "#ffd700" }}>
                                                    {watchedItems?.reduce((sum: number, q: any) => sum + (q?.points || 0), 0) || 0}
                                                </strong>
                                            </Text>
                                        </Box>
                                        <Button
                                            ...
                                            styles={{
                                                root: {
                                                    ...
                                                    "&:hover": {
                                                        ...
                                                        boxShadow:
                                                            !isEditing && fields.length > 0 ? "0 12px 24px rgba(255, 165, 0, 0.4)" : undefined,
                                                    },
                                                },
                                            }}
                                        >
                                            Create Quiz ({fields.length} question{fields.length !== 1 ? "s" : ""})
                                        </Button>
                                    </Group>
                                </Paper>
                            )}
