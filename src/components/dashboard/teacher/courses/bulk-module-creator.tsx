        ...
        >
            <Box style={{ maxWidth: rem(1200), margin: "0 auto" }}>
                ...
                <Paper
                    ...
                    mb="xl"
                    style={{
                        background: "linear-gradient(135deg, #bdf052 0%, #a8e042 50%, #93d032 100%)",
                        position: "relative",
                        overflow: "hidden",
                        border: "none",
                    }}
                ...
                <Stack gap="lg">
                    ...
                    >
                        <Group justify="space-between" mb="xl">
                            ...
                            <Button
                                ...
                                styles={{
                                    root: {
                                        background: canAddMore ? "linear-gradient(135deg, #bdf052 0%, #a8e042 100%)" : undefined,
                                        color: "#222222",
                                        fontWeight: 600,
                                        border: "none",
                                        transition: "all 0.2s ease",
                                        "&:hover": {
                                            ...
                                            boxShadow: canAddMore ? "0 8px 20px rgba(189, 240, 82, 0.3)" : undefined,
                                        },
                                    },
                                }}
                            >
                        ...
                        {fields.length === 0 ? (
                            ...
                            >
                                <IconSparkles size={48} color="#b3a1ff" style={{ margin: "0 auto 16px" }} />
                                <Text c="#b3a1ff" size="md" fw={500} mb={8}>
                                    No modules yet
                                </Text>
                                <Text c="dimmed" size="sm">
                                    Click "Add Module" to start creating your course content
                                </Text>
                            </Paper>
                        ) : (
                            <Stack gap="md">
                                                ...
                                                <Paper
                                                    style={{
                                                        ...
                                                        background: isCurrentlyEditing
                                                            ...
                                                            : "#2a2a2a",
                                                        border: isCurrentlyEditing ? "2px solid #bdf052" : "1px solid rgba(255, 255, 255, 0.1)",
                                                    ...
                                                    {isCurrentlyEditing ? (
                                                        <Stack gap="md">
                                                            <Group justify="space-between" align="center">
                                                                ...
                                                                >
                                                                    {isAddingNew ? "New Module" : `Editing Module #${index + 1}`}
                                                                </Badge>
                                                                <ActionIcon
                                                                    variant="subtle"
                                                                    color="gray"
                                                            ...
                                                            <Group grow align="flex-start">
                                                                ...
                                                                <Box>
                                                                    ...
                                                                    <Switch
                                                                        ...
                                                                        size="md"
                                                                        color="lime"
                                                                        {...register(`modules.${index}.is_published`)}
                                                                        styles={{
                                                                            label: {
                                                                                color: "#e9eeea",
                                                                                cursor: "pointer",
                                                                    ...
                                                                    styles={{
                                                                        root: {
                                                                            ...
                                                                            "&:hover": {
                                                                                ...
                                                                                boxShadow: "0 8px 20px rgba(189, 240, 82, 0.3)",
                                                                            },
                                                                        },
                                                                    }}
                                                                >
                                                            ...
                                                            <Group gap="md" style={{ flex: 1 }}>
                                                                <Box
                                                                    style={{
                                                                        ...
                                                                        fontWeight: 700,
                                                                        fontSize: rem(18),
                                                                        boxShadow: "0 4px 12px rgba(189, 240, 82, 0.2)",
                                                                    }}
                                                                >
                                                                    {index + 1}
                                                                </Box>
                    ...
                    {/* Submit Section */}
                    {fields.length > 0 && (
                        <Transition mounted={fields.length > 0} transition="slide-up" duration={400} timingFunction="ease">
                            {(styles) => (
                                <Paper
                                    style={{
                                        ...styles,
                                        background: "linear-gradient(135deg, rgba(189, 240, 82, 0.1) 0%, rgba(179, 161, 255, 0.1) 100%)",
                                ...
                                >
                                    <Group justify="space-between" align="center">
                                        <Box>
                                            ...
                                            <Text size="sm" c="dimmed">
                                                You have <strong style={{ color: "#ffffff" }}>{fields.length}</strong> module
                                                {fields.length !== 1 ? "s" : ""} ready to be added to your course
                                            </Text>
                                        </Box>
                                        <Button
                                            ...
                                            styles={{
                                                root: {
                                                    ...
                                                    transition: "all 0.2s ease",
                                                    "&:hover": {
                                                        transform: !isEditing && fields.length > 0 ? "translateY(-2px)" : undefined,
                                                        boxShadow:
                                                            !isEditing && fields.length > 0 ? "0 12px 24px rgba(189, 240, 82, 0.4)" : undefined,
                                                    },
                                                },
                                            }}
                                        >
                                            Create {fields.length} Module{fields.length !== 1 ? "s" : ""}
                                        </Button>
                                    </Group>
                                </Paper>
                            )}
