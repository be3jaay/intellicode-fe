...
export function QuizFormContentStep({
  ...
  const totalQuestionPoints =
    watchedItems?.reduce((sum: number, q: any) => sum + (q?.points || 0), 0) ||
    0;
                        ...
                        <Stack gap="md">
                          ...
                          {questionType === "enumeration" && (
                            <Box>
                              ...
                              <Stack gap="xs">
                                {(
                                  watch(`questions.${index}.correct_answers`) ||
                                  []
                                ).map((_: any, ansIndex: number) => (
                          ...
                          {questionType === "identification" && (
                            <Box>
                              ...
                              <Switch
                                ...
                                mt="sm"
                                checked={
                                  watch(`questions.${index}.case_sensitive`) ||
                                  false
                                }
                                onChange={(event) =>
                                  setValue(
                          ...
                          {questionType === "true_false" && (
                            <Box>
                              ...
                              <Radio.Group
                                value={
                                  watch(`questions.${index}.is_true`) === true
                                    ? "true"
                                    : "false"
                                }
                                onChange={(value) =>
        ...
        {fields.length > 0 && !pointsMatch && (
          ...
          >
            <Group gap="xs">
              ...
              <Text size="sm" c="dimmed">
                Question points total ({totalQuestionPoints}) must equal
                assignment points ({totalAssignmentPoints})
              </Text>
            </Group>
          </Paper>
        )}
        ...
        <Group justify="space-between">
          ...
          <Button
            ...
            onClick={() => {
              if (!pointsMatch) {
                alert(
                  `Points mismatch! Question points (${totalQuestionPoints}) must equal assignment points (${totalAssignmentPoints})`
                );
                return;
              }
              onSubmit();
            ...
            styles={{
              root: {
                ...
                "&:hover": {
                  ...
                  boxShadow: canSubmit
                    ? "0 8px 20px rgba(149, 133, 230, 0.4)"
                    : undefined,
                },
              },
            }}
