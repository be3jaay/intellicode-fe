"use client"
import { Box, Group, Stack, Text, Paper, Button, rem, Textarea } from "@mantine/core"
...
export function CodeSandboxContentStep({ register, onBack, onSubmit }: CodeSandboxContentStepProps) {
    return (
        <Stack gap="lg" mt="xl">
            <Paper
                p="lg"
            ...
            <Box>
                ...
                <Textarea
                    {...register("testCases")}
                    placeholder="// Add test cases to validate student code..."
                    minRows={8}
                    styles={{
                        input: {
                            background: "#1a1a1a",
