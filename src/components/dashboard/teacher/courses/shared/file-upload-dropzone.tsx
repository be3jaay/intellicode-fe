...
import { IconUpload, IconFile, IconX, IconFileTypePdf, IconPhoto } from "@tabler/icons-react"
...
export function FileUploadDropzone({
    onFileChange,
    acceptedTypes = [MIME_TYPES.pdf, ...Object.values(MIME_TYPES).filter(type => type.startsWith('image/'))],
                ...
                >
                    <Group justify="space-between" wrap="nowrap">
                        ...
                        <Box
                            ...
                            onMouseOver={(e) => {
                                e.currentTarget.style.background = "rgba(246, 172, 174, 0.2)"
                            }}
                            onMouseOut={(e) => {
                                e.currentTarget.style.background = "rgba(246, 172, 174, 0.1)"
                            }}
                        >
