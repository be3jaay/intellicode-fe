    ...
    <Box style={{ minHeight: "100vh" }}>
      ...
      <Box>
        ...
        <Paper
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(79, 209, 197, 0.1) 0%, rgba(56, 178, 172, 0.1) 100%)",
          ...
          <Group justify="space-between" align="center">
            <Box>
              ...
              <Text size="sm" c="dimmed">
                Students will be able to view {fields.length} lesson
                {fields.length > 1 ? "s" : ""} content
              </Text>
            </Box>
            <Button
              leftSection={
                bulkLessonMutation.isPending ? undefined : (
