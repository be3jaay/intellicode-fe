...
export function ModuleSelector({ course, onModuleSelect, onBack }: ModuleSelectorProps) {
    ...
    if (isLoading) {
        return (
            <Box style={{ minHeight: "100vh" }}>
                <Paper shadow="xl" p="xl" radius="lg" mb="xl" style={{
    ...
    return (
        <Box style={{ minHeight: "100vh" }}>
            ...
            {/* Module Selection */}
            <Paper shadow="md" p="xl" radius="lg" mb="xl" style={{
                background: "#222222",
                ...
                <Stack gap="lg">
                    ...
                    {modulesData.length === 0 ? (
                        <Alert color="yellow" title="No Modules Found">
                            This course doesn't have any modules yet. Please create modules first.
                        </Alert>
                    ) : (
                        <Grid>
                            {modulesData.map((module) => (
                                <Grid.Col key={module.module_id} span={{ base: 12, md: 6 }}>
                                    <Card
                                        ...
                                        radius="md"
                                        style={{
                                            background: selectedModule === module.module_id ? "rgba(79, 209, 197, 0.1)" : "#1a1a1a",
                                            border: selectedModule === module.module_id ? "2px solid #4fd1c5" : "1px solid #333",
                                            cursor: "pointer",
                                    ...
                                    >
                                        <Group justify="space-between" mb="xs">
                                            <Text fw={500} c={selectedModule === module.module_id ? "#4fd1c5" : "#fff"}>
                                                {module.module_title}
                                            </Text>
