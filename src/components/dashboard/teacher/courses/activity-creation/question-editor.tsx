    ...
    <Stack gap="md">
      ...
      {questionType === "multiple_choice" && (
        <Box>
                ...
                <Group key={optIndex} gap="xs">
                  ...
                  {(watch(`questions.${index}.options`) || []).length > 2 && (
                    <ActionIcon
                      color="red"
                      variant="light"
                      onClick={() => removeMcOption(optIndex)}
                    >
                      <IconTrash size={16} />
                    </ActionIcon>
                  )}
          ...
          <Select
            ...
            data={(watch(`questions.${index}.options`) || []).map(
              (opt: string, i: number) => ({
                value: String(i),
            ...
            onChange={(value) =>
              setValue(`questions.${index}.correct_answer`, value || "")
            }
            mt="sm"
            styles={{
        ...
        <Box>
          <Group justify="space-between" mb="sm">
            ...
            <Button
              ...
              disabled={
                (watch(`questions.${index}.correct_answers`) || []).length >= 10
              }
            >
              <IconPlus size={14} />
            </Button>
          ...
          <Stack gap="xs">
            {(watch(`questions.${index}.correct_answers`) || []).map(
              (_: any, ansIndex: number) => (
                <Group key={ansIndex} gap="xs">
                  ...
                  />
                  {(watch(`questions.${index}.correct_answers`) || []).length >
                    1 && (
                    <ActionIcon
                      color="red"
                      variant="light"
      ...
      {questionType === "true_false" && (
        <Box>
          ...
          <Radio.Group
            value={
              watch(`questions.${index}.is_true`) === true ? "true" : "false"
            }
            onChange={(value) =>
              setValue(`questions.${index}.is_true`, value === "true")
            }
          >
            <Group>
